...
class product_table {
    ...
    protected function set_results($product_name, $product_id, $date_set, $date_start, $date_end, $page, $results_per_page)
    {
        ...
        $get_product_rows = new products_search($product_name, $product_id, $date_set, $date_start, $date_end, $row_start, $row_end, true);
        return $get_product_rows->return_results();
    }
