...
class build_review_form
{
     ...
     */
    protected function set_product_options(array $product_array)
    {
        $options = '';
     ...
     * @return string
     */
    protected function build_review_form($thank_you)
    {
        if ($thank_you == true)
        {
        ...
        $product_options = $this->set_product_options($this->product_array);
        ...
        $form_html = "    <form id='review_form' class='' name='contact' action='php/review_submit_act.php' method='post'>
                            ...
                            <div class='row'>
                                <label>
                                    <select id='product' class='selectprod $error_class_product' name='product'>
    ...
    public function return_review_form()
    {
